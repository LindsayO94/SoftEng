...
public class LevelSelectPanel extends JPanel {
	...
	JButton puzzle1Button;
	JButton loadCustomLevelButton;
	...
	public LevelSelectPanel() {
		...
		puzzle1Button = new JButton("1");
		puzzle1Button.setFont(new Font("Tahoma", Font.PLAIN, 14));
		puzzle1Button.addActionListener(new ActionListener() {
		...
		loadCustomLevelButton = new JButton("Load Custom Level");
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
									.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
										.addComponent(puzzle1Button, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE)
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(loadCustomLevelButton))))
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
								.addComponent(loadCustomLevelButton, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(mainMenuButton, GroupLayout.DEFAULT_SIZE, 59, Short.MAX_VALUE))))
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(18)
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
								...
								.addComponent(puzzle1Button, GroupLayout.PREFERRED_SIZE, 56, GroupLayout.PREFERRED_SIZE))
							.addGap(26)
							.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
		...
		groupLayout.linkSize(SwingConstants.VERTICAL, new Component[] {puzzle1Button, button, button_1, button_2, button_3, button_4, button_5, button_6, button_7, button_8, button_9, button_10, button_11, button_12, button_13, button_14, button_15, button_16, button_17, button_18});
		groupLayout.linkSize(SwingConstants.HORIZONTAL, new Component[] {puzzle1Button, button, button_1, button_2, button_3, button_4, button_5, button_6, button_7, button_8, button_9, button_10, button_11, button_12, button_13, button_14, button_15, button_16, button_17, button_18});
	...
	public JButton getLoadCustomLevelButton(){
