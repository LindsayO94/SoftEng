...
/**
 * Controller which handles changes to the Multiplier field on the EditPanel
 * @author August
 *
 */
public class MultiplierFieldController implements UndoableEditListener {
	 ...
	 * @param index: an index indicating which Multiplier Frequency Field this controller is assigned to
